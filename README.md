...
⚠️ **This project is not ready to run in production.** Please wait for our first release before you attempt to deploy it. Self-hosting instructions and Docker releases will be available soon.
